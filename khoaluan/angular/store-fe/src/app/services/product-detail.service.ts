...
export class ProductDetailService {
    constructor(
        ...
        this.ProductDetailSub = new BehaviorSubject<Product>(this.product);
    ...
    private API: string = environment.api_url + '/api/';
    private product: Product;
    private images: DanhMucHinh[] = [];
    private ratings: Rating[] = [];
    public ProductDetailSub: BehaviorSubject<Product>;
    public ProductDetailObs: Observable<Product>;
